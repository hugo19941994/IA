...
<head>
    ...
    <!-- Document Title
	============================================= -->
    <title>Everis - Búsqueda de CVs</title>
                        ...
                        <div id="collapse2" class="panel-collapse collapse in">
                            <div id="contenedorOpcional" class="panel-body">
                                <div class="text-center">
                                  <!--  <button id="volverBuscar" name="buscar" class="btn btn-primary center-block">Volver a buscar</button>-->
                            ...
                            <div id="formularioBusqueda" class="panel-body text-center form-horizontal">
                                ...
                                <div class="col_full">
                                    <!--<button id="buscarAhora" name="buscarp" class="btn btn-primary center-block">Iniciar búsqueda</button>-->
